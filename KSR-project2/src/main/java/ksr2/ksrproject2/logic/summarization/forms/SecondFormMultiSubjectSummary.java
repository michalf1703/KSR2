...
public class SecondFormMultiSubjectSummary implements MultiSubjectSummary {
    ...
    public SecondFormMultiSubjectSummary(Quantifier quantifier, List<Label> summarizers, List<Label> qualifiers, List<PowerliftingResultDetalis> detalis1, List<PowerliftingResultDetalis> detalis2) {
